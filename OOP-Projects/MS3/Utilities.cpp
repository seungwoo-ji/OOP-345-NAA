...
std::string Utilities::extractToken(const std::string& str, size_t& next_pos, bool& more)
{
	...
	if (more)
	{
		...
		more = delimitPos == std::string::npos ? false : true; // return true if the delimiter is found
		...
		if (token.empty()) // throw exception when the extracted token is empty (e.g. "x,,y" or "z,")
		{
